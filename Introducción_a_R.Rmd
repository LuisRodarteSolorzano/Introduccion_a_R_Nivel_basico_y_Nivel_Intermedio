...
### Declarar matrices
Existen dos formas para declarar matrices en R, una es por columnas y otra es por filas.  A continuación, se presentan ambos casos:
...
La función barplot(), se utiliza para realizar gráficos de barra.  Esta gráfica nos muestra la frecuencia con la que se han observado los datos de una variable discreta.  Suponga que se tienen 11 personas del género femenino y 21 personas del género masculino.
...
```{r}
barplot(c(11, 21), names.arg = c("Femenino", "Masculino"), main = "Título del gráfico", sub = "Subtítulo del gráfico", xlab = "Etiqueta del eje x", ylab = "Etiqueta del eje y", col = c("pink", "blue"))
```
